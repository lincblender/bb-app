...
import { PARADIGM_MODEL_ALLOCATION } from "./model-allocation.generated.ts";
...
export function getReasoningEffort(profile: string): "low" | "medium" | "high" {
...
export function getModelForJob(paradigm: string, profile: string): string {
  const alloc = PARADIGM_MODEL_ALLOCATION[paradigm as keyof typeof PARADIGM_MODEL_ALLOCATION];
  if (!alloc) {
